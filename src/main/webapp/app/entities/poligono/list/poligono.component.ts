...
import { EntityArrayResponseType, PoligonoService } from '../service/poligono.service';
import { PoligonoDeleteDialogComponent } from '../delete/poligono-delete-dialog.component';
import { ParseLinks } from 'app/core/util/parse-links.service';

@Component({
  selector: 'jhi-poligono',
...
export class PoligonoComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPoligono): number => this.poligonoService.getPoligonoIdentifier(item);

  ngOnInit(): void {
    this.load();
  }

  delete(poligono: IPoligono): void {
    const modalRef = this.modalService.open(PoligonoDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.poligono = poligono;
